...
- App 端已补帮助中心、账户支持中心和通知中心，并把“我的 / 资料 / 设置 / 首页 / 消息 / 提醒”等入口接入统一辅助流，账户帮助逻辑不再继续堆在旧入口里。
- 订单详情页已重构为概览 / 沟通 / 履约 / 售后分段视图，评价、投诉、退款进度、消息沟通等关键能力可按场景进入。
- 旧的综合工作台已保留为兼容入口，但新的照料者入口已默认进入拆分后的页面体系。
- 相比 Web 端，App 端在系统级主动提醒、进一步打磨交互完整性和更多治理辅助能力上仍有缺口。

### 2.4 当前主要短板

- App 端主人与照料者核心主流程已经拆开，帮助中心、账户支持页和通知中心也已落地，但系统级主动提醒与更细的新手引导仍未收口。
...
- 第一优先级继续是 App / Web 用户操作逻辑页面重构，但 App 端下一步重点已从“通知中心补齐”转向“系统级主动提醒、推送触达与更细的新手引导收口”。
