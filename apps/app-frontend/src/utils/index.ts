...
const pages = (pagesJson.pages || []) as PageMetaDatum[]
const subPackages = (pagesJson.subPackages || []) as SubPackages
...
export function currRoute() {
  ...
  // console.log('lastPage.options:', lastPage.options)
 ...
 * 当前 PetPal App 通常为 /pages/petpal/owner-home
 */
export const HOME_PAGE = `/${pages.find(page => page.type === 'home')?.path || pages[0]?.path || 'pages/index/index'}`
