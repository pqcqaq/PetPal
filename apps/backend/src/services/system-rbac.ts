  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        title: 'OAuth 供应商',
        caption: 'Providers',
        description: '维护第三方登录供应商的端点、声明映射、登录策略与密钥配置。',
        icon: 'i-carbon-license',
        path: '/oauth/providers',
        viewKey: 'oauthProviders',
        sortOrder: 30,
        permissionCode: 'oauth-provider.read',
        children: [
          { code: 'oauth-providers-create', type: 'ACTION', title: '创建 OAuth 供应商', icon: 'i-carbon-add', sortOrder: 10, permissionCode: 'oauth-provider.create' },
          { code: 'oauth-providers-update', type: 'ACTION', title: '编辑 OAuth 供应商', icon: 'i-carbon-edit', sortOrder: 20, permissionCode: 'oauth-provider.update' },
          { code: 'oauth-providers-delete', type: 'ACTION', title: '删除 OAuth 供应商', icon: 'i-carbon-trash-can', sortOrder: 30, permissionCode: 'oauth-provider.delete' },
        ],
      },
      {
        ...
        description: '维护作为认证客户端接入本系统的应用信息、回调地址、默认 scope 与权限映射。',
        icon: 'i-carbon-app-connectivity',
        path: '/oauth/applications',
        viewKey: 'oauthApplications',
        sortOrder: 40,
        permissionCode: 'oauth-application.read',
        children: [
          { code: 'oauth-applications-create', type: 'ACTION', title: '创建 OAuth 应用', icon: 'i-carbon-add', sortOrder: 10, permissionCode: 'oauth-application.create' },
          { code: 'oauth-applications-update', type: 'ACTION', title: '编辑 OAuth 应用', icon: 'i-carbon-edit', sortOrder: 20, permissionCode: 'oauth-application.update' },
