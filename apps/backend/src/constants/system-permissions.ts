...
export const systemPermissionCatalog: readonly SystemPermissionSeed[] = [
  ...
  { module: 'petpal', code: 'petpal.penalty.read', name: '查看宠托帮违规处罚', action: 'read' },
  { module: 'petpal', code: 'petpal.penalty.manage', name: '处理宠托帮违规处罚', action: 'manage' },
  { module: 'petpal', code: 'petpal.rule.read', name: '查看宠托帮平台规则', action: 'read' },
  { module: 'petpal', code: 'petpal.rule.publish', name: '发布宠托帮平台规则', action: 'publish' },
  ...
  { module: 'file', code: 'file.upload.avatar', name: '上传头像', action: 'create' },
  ...
  { module: 'realtime-topic', code: 'realtime-topic.read', name: '查看订阅授权', action: 'read' },
  { module: 'realtime-topic', code: 'realtime-topic.create', name: '创建订阅授权', action: 'create' },
  { module: 'realtime-topic', code: 'realtime-topic.update', name: '编辑订阅授权', action: 'update' },
