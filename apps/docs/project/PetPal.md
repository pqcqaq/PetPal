...
| 消息与回传 | 订单会话、图文消息、过程媒体、未读数 | 基本完成，跨订单聚合与提醒中心已完成，仍缺主动通知 | P2 |
| 支付与退款 | 多次支付、补差价、部分退款、回调审计、对账 | 核心已完成 | P4 |
| 评价与投诉 | 评价、标签、投诉、处理日志、仲裁结论 | 基本完成，售后中心已落地，仍缺帮助体系与主动通知 | P2 |
...
| App 端 | 约 79% | 主人与照料者核心流程页面已拆开，并完成 Material 3 设计基线、角色入口、资料/设置/帮助/账户支持等关键入口统一；仍缺真正的主动通知 |
...
1. `app-frontend` 已形成真实可用的 PetPal 主应用骨架，帮助中心和账户支持页已落地，但更多新手引导与主动通知仍未收口。
...
- App 端下一步准备继续补真正的主动提醒、统一通知流和更细的帮助引导，不再继续扩大旧兼容工作台。
