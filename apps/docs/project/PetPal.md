...
| 消息与回传 | 订单会话、图文消息、过程媒体、未读数 | 基本完成，跨订单聚合已完成，仍缺主动通知 | P2 |
| 支付与退款 | 多次支付、补差价、部分退款、回调审计、对账 | 核心已完成 | P4 |
| 评价与投诉 | 评价、标签、投诉、处理日志、仲裁结论 | 基本完成，仍缺主动提醒与帮助体系 | P2 |
...
| App 端 | 约 74% | 主人与照料者核心流程页面已拆开，并补上跨订单消息中心、收益表现页与主人售后中心；仍缺主动提醒和更多辅助页 |
...
| 评价与投诉 | 基本完成 | Web 端已支持评价、投诉、售后时间线；App 端也已具备订单详情提交与独立售后中心查看能力，但仍缺主动提醒与帮助体系 |
...
3. 主动提醒与统一通知流尚未落地，售后和消息仍需要更主动的到达能力。
