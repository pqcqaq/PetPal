...
| 消息与回传 | 订单会话、图文消息、过程媒体、未读数 | 基本完成，缺跨订单聚合与主动通知 | P2 |
| 支付与退款 | 多次支付、补差价、部分退款、回调审计、对账 | 核心已完成 | P4 |
| 评价与投诉 | 评价、标签、投诉、处理日志、仲裁结论 | 部分完成 | P2 |
...
| App 端 | 约 50% | 已完成 PetPal 化基础页面，但仍未完成按角色与场景拆分的真实业务主应用重构 |
