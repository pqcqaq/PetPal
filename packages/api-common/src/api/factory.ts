  ...
  return {
    ...
    petpal: {
      ...
      orders: {
        ...
        create: (payload: CreateOwnerOrderPayload) =>
        ...
        pay: (id: string, payload: PayOwnerOrderPayload) =>
          client.request<OrderDetailRecord>({
            url: `/petpal/orders/${id}/pay`,
            method: 'POST',
            data: payload,
          }),
        messages: (id: string) =>
        ...
        exportRefundDetails: createDownloadEndpoint<OwnerRefundExportQuery>(
      ...
      admin: {
        ...
        callbackAlertOutboxReplayLogs: (id: string, query: CallbackAlertReplayLogQuery = {}) =>
          client.request<CallbackAlertReplayLogPage>({
